...
describe('ArticleService', () => {
  ...
  Date.now = jest.fn().mockReturnValue(new Date('2021-12-01').valueOf());
        ...
        .mockImplementation(async (count: number) => {
          return [
            new ArticleEntity(
              ...
              'title1',
              'link1',
              admin.firestore.Timestamp.fromDate(new Date('2021-12-01')),
            ),
            new ArticleEntity(
              'key2',
              'title2',
              'link2',
              admin.firestore.Timestamp.fromDate(new Date('2021-12-02')),
            ),
          ];
        });
